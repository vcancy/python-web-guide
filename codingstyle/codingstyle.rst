...
- 如果是小团队(python大团队会死人的)并且人都比较懒就那就『代码即文档』（有程序员说你让程序员写文档不是天方夜谭吗？你丫的哪个牛逼开源项目的文档是产品经理写的吗？？？excuse me, 代码写不好文档能好看点也行啊）。python的特色docstring实际上就是最好的文档。
...
分枝与代码管理
--------------------------------------
做好代码分枝管理，分清楚开发、特性、bugfix等代码分枝，不要在同一个分枝上一下修改太多功能，导致修复问题不好定位。
