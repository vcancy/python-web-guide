...
* 代码应当易于理解。 《代码大全》、《编写可读代码的艺术》、《代码整洁之道》啥的都是告诉你代码最好自解释，好理解。记住代码首先是给人看的，其次才是让机器执行的，不要过度设计。同时警惕你觉得过于『精巧』的实现，很有可能成为以后代码维护的大坑。可读性基本定律：代码的写法应该使别人理解它所需的时间最小化。聪明的程序员可能写出复杂、精巧的代码，专业的程序员会写出可读性高的代码。
...
警惕某种程序猿
--------------------------------------
当然我上边废了这么多话，你可能心想着：老板又不管你代码写成啥个鸟样子，早点干完活回家不就得了。想的忒对，一般碰见这种程序员比较多的公司，先建议你扑腾一阵，如果实在束手无策又没啥话语权的时候，咱就只能：收拾包袱，让别人擦屁股吧，我还想多活几年呢！！！
